namespace OwO_Maker.Helpers
{
    public class Structs
    {
        public class Pattern
        {
            ...
            // From NosSmooth.Local (PlayerManagerOptions). The A1 instruction is at +5,
            // so its operand (static address of the PlayerManager global) is at +6.
            public static readonly string TPlayerManager = "33 C9 8B 55 FC A1 ?? ?? ?? ?? E8 ?? ?? ?? ??";
        ...
        {
            public static nint Player = 0x20;   // pointer to the player object; 0 = login / character select
            public static nint PlayerId = 0x24; // int
        }

        public class TMapPlayer
        {
            public static nint NamePtr = 0x1EC; // pointer to Delphi AnsiString (length int at ptr - 4, ASCII data at ptr)
        }

        public class TMiniGameManager
        {
            public static nint CurrentMinigamePtr = 0xC;
            public static nint CurrentMinigameType = 0x70;
            public static nint StoneQuarryPtr = 0x78;
        ...
        {
            public static nint ProductionPoints = 0xD0;
        }

        public class TMiniGameDurability
        {
            public static nint Durability = 0x130;
        }
